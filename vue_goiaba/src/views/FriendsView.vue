            ...
            >
                ...
                <img :src="friendshipRequest.created_by.get_avatar" class="mb-6 mx-auto rounded-full">
                    ...
                    <div class="mt-6 space-x-4">
                        <button class="inline-block py-4 px-6 bg-pink-600 text-white" @click="handleRequest('accepted', friendshipRequest.created_by.id)">Accept</button>
                        <button class="inline-block py-4 px-6 bg-red-600 text-white" @click="handleRequest('rejected', friendshipRequest.created_by.id)">Reject</button>
                    </div>
                </div>
